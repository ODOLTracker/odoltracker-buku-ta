...
%   & \textbf{Min} & \textbf{Max} & \textbf{Min} & \textbf{Max} \\
%   \hline
%   NVIDIA Jetson Nano 4GB & 78.2 & 83.5 & 11.97 & 12.79 \\
%   \hline
%   Beelink Gemini T34 & 105.6 & 112.8 & 8.86 & 9.47 \\
%   \hline
%   \end{tabular}
%   \caption{Perbandingan waktu inferensi dan FPS pada perangkat edge}
%   \label{tab:inference_time}
...
% \begin{figure}[htbp]
%   \centering
%   \includegraphics[width=1\textwidth]{gambar/bab4-jetson-fps-over-time.png}
%   \caption{Perubahan FPS terhadap waktu pada perangkat NVIDIA Jetson Nano 4GB}
%   \label{fig:jetson_fps_over_time}
% \end{figure}

% \begin{figure}[htbp]
%   \centering
%   \includegraphics[width=0.8\textwidth]{gambar/bab4-beelink-fps-over-time.png}
%   \caption{Perubahan FPS terhadap waktu pada perangkat Beelink Gemini T34}
%   \label{fig:beelink_fps_over_time}
% \end{figure}

% Gambar \ref{fig:jetson_fps_over_time} dan \ref{fig:beelink_fps_over_time} menampilkan perbandingan performa FPS kedua perangkat selama periode pengujian. 
...
%   \hline
%   \rowcolor[HTML]{C0C0C0}
%   \textbf{Perangkat} & \multicolumn{2}{c|}{\textbf{CPU (\%)}} & \multicolumn{2}{c|}{\textbf{GPU (\%)}} & \multicolumn{2}{c|}{\textbf{RAM (MB)}} & \multicolumn{2}{c|}{\textbf{Temp. (°C)}} \\
%   \cline{2-9}
%   \rowcolor[HTML]{C0C0C0}
%   & \textbf{Min} & \textbf{Max} & \textbf{Min} & \textbf{Max} & \textbf{Min} & \textbf{Max} & \textbf{Min} & \textbf{Max} \\
%   \hline
%   NVIDIA Jetson Nano & 39.5 & 61.1 & 0.0 & 99.0 & 2667 & 2773 & 39.0 & 50.0 \\
%   \hline
%   Beelink Gemini T34 & 45.3 & 60.2 & 1.5 & 3.0 & 780 & 812 & 38.5 & 42.0 \\
%   \hline
%   \end{tabular}
%   \caption{Penggunaan resource dan suhu pada perangkat \emph{edge} selama pengujian model}
%   \label{tab:resource_usage}
